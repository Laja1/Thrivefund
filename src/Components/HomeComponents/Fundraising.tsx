...
export default function Fundraising() {
 ...
 <motion.div  initial={{opacity:0.5, x:-60}} whileInView={{opacity:1,x:0}} transition={{duration:1,}}><img src='/pictures/give.jpg' className='w-[90vh] lg:w-full md:'/></motion.div>
 </div> 
 ...
 <div className='flex-col flex gap-2 '>
    <a href='#campaigns'><p className='loraa'>Quick Fundraising</p>
    <p className='lora text-sm w-52'>Find and support the causes you care about with ease.</p></a>
 </div>
 </div>
  <div className='flex-row flex gap-3'><img src='icons/startDonating.svg'/>
   <a href='#campaigns'><div className='flex-col flex gap-2 '>
