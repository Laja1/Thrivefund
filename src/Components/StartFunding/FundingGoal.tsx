...
export default function FundingGoal({ defaultValues, onNext, onPrevious }: FundingGoalProps) {
  ...
  return (
    <div className="pt-5">
      <p className='text-3xl font-bold loraa pb-3'>How much money are you looking to raise?</p>

      <form onSubmit={onSubmit}>
        <div className="flex gap-2 flex-col">
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-900 lora dark:text-white">Fundraiser Title</label>
            <input {...register('fundraiserTitle')} type="text" className="bg-gray-50 border border-gray-300 text-gray-900 lora text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Fundraiser Title" />
            {errors.fundraiserTitle && <p className="text-red-600 text-sm">{errors.fundraiserTitle.message}</p>}
          </div>
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-900 lora dark:text-white">Fundraiser Description or Story</label>
            <textarea {...register('fundraiserDescription')} className="bg-gray-50 border border-gray-300 text-gray-900 lora text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Provide a detailed description of your fundraiser." />
          ...
          <div className="grid gap-6 mb-6 md:grid-cols-2">
            <div>
              <label className="block mb-2 text-sm font-medium text-gray-900 lora dark:text-white">Fundraising Goal</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500">₦</span>
                <input type="text" {...register('goal')} className="pl-7 bg-gray-50 border border-gray-300 text-gray-900 lora text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="10" />
              </div>
              {errors.goal && <p className="text-red-600 text-sm">{errors.goal.message}</p>}
              <p className="text-gray-500  lora text-sm mt-1">How much money do you aim to raise?</p>
            </div>

            <div>
              <label className="block mb-2 text-sm font-medium text-gray-900 lora dark:text-white">Campaign Category</label>
              <select {...register('category')} className="bg-gray-50 border border-gray-300 text-gray-900 lora text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option className="lora" value="">Choose a campaign</option>
                <option className="lora" value="Medical">Medical</option>
                <option className="lora" value="Education">Education</option>
                <option className="lora" value="Business">Business</option>
                <option className="lora" value="Others">Others</option>
              </select>
          ...
          <div className="mb-6 flex-col justify-center flex">
            <label className="block mb-2 text-sm font-medium text-gray-900 lora dark:text-white">Deadline For Your Fundraiser</label>
            <div className="relative max-w-sm">
              ...
              <input type="date" {...register('deadline')} className="bg-gray-50 border lora border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date" />
            </div>
