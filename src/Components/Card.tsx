  ...
  return (
    <div className="w-[300px] border-[1px] shadow-xl  border-[#fdfdf] flex flex-col rounded-md">
          ...
          <div className="px-5  flex flex-col">
              <div className="flex-row flex justify-between"> <p className="font-bold loraa">{campaignName}</p> <p className="text-blue-400 lora">{cases} cases</p></div>
              <p className="text-sm leading-loose  lora py-5">{text}</p>
